...
module.exports = {
  ...
  const embed = new MessageEmbed()
    ...
    const done = new MessageEmbed()
       .setDescription(`Your suggestion is Submitted here, <#${channel}>\n\nNote: You agreed to get a DM on a reply over your Suggestion! [cosmos open source bot](https://github.com/crt-romain78/cosmos-bot)`)
       .setColor("00FFFF")
    ...
    await msgEmbed.react(':up:')
    await msgEmbed.react(':down:')
  }
}
